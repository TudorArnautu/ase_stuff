...
public:
	...
	Companie(char *nume_companie, int nr_angajati, int *salariu, int departamente, int salariu_ora, int new_cod) :cod(new_cod) {
...
int main() {
	...
	//operator >=
	if (obiect >= obiect1)
		cout << "\nPrima companie are mai multe departamente fata de a doua companie.";
	else
		cout << "\nA doua companie are mai multe departamente fata de prima companie.";

	cout << endl << endl;

	//operator==
	if (obiect == obiect1)
		cout << "Prima companie are mai multiangajati fata de a doua companie.";
	else
		cout << "A doua companie are mai multi angajati fata de prima companie.";
