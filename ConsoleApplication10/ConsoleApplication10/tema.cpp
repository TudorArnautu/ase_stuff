...
private: void afisare() {
			 cout << "Garsoniera este de tip " << tip << " si are un numar de camere " << nr_camere << " cu un numar de locatari de " << nr_locatari << " si cu o suprafata de " << suprafata << " cu adresa " << adresa << "\n";
}
...
int main() {
	...
	cout << "Tipul garsonierei este: "; cin >> s;
	strcpy(casa1.tip, s);
